...
Una vez creadas las series temporales, estas se normalizaron usando un logaritmo para suavizar los cortes y las varianzas favoreciendo un mejor análisis y comprensión visual de la misma. 
\pagebreak
\clearpage
%---------------------------------------------------