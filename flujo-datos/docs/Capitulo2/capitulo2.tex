...
Los resultados de estos experimentos pueden verse en la tabla \ref{tabla3}.
...
\begin{figure}[h]
	\centering
		\includegraphics[scale=0.35]{./Capitulo2/imagenes/semilla1vs2.png}
		\caption{Gráfico de evolución ACC entre semilla 1 y 2  en HoeffdingTree .}
	\label{semilla1vs2}
\end{figure}

\begin{figure}[h]
	\centering
		\includegraphics[scale=0.35]{./Capitulo2/imagenes/semilla2vs3.png}
		\caption{Gráfico de evolución ACC entre semilla 2 y 3  en HoeffdingTree .}
	\label{semilla2vs3}
\end{figure}

\begin{figure}[h]
	\centering
		\includegraphics[scale=0.35]{./Capitulo2/imagenes/semilla3vs1.png}
		\caption{Gráfico de evolución ACC entre semilla 3 y 1  en HoeffdingTree .}
	\label{semilla3vs1}
\end{figure}
...
\begin{figure}[h]
	\centering
		\includegraphics[scale=0.35]{./Capitulo2/imagenes/sa2vs1.png}
		\caption{Gráfico de evolución ACC entre semilla 1 y 2  en HoeffdingTree Adaptativo.}
	\label{sa2vs1}
\end{figure}

\begin{figure}[h]
	\centering
		\includegraphics[scale=0.35]{./Capitulo2/imagenes/sa2vs3.png}
		\caption{Gráfico de evolución ACC entre semilla 2 y 3  en HoeffdingTree Adaptativo.}
	\label{sa2vs3}
\end{figure}

\begin{figure}[h]
	\centering
		\includegraphics[scale=0.35]{./Capitulo2/imagenes/sa3vs1.png}
		\caption{Gráfico de evolución ACC entre semilla 3 y 1  en HoeffdingTree Adaptativo.}
	\label{sa3vs1}
\end{figure}
